...
(function (TheDatepicker) {
  const CannotParseDateException = (function () {
  ...
  const DateConverter_ = (function () {
        ...
        if (escapeNext) {
          ...
          if (parser !== null) {
            try {
              ...
              const textChar_1 = text.substring(textPosition, textPosition + 1);
              if (textChar_1 === ' ') {
                textPosition++;
                position--;
                continue;
    ...
    DateConverter_.prototype.parseDayOfWeekTextual_ = function (text) {
      const _this = this;
      return this.parseDayOfWeekByTranslator_(text, (dayOfWeek) => _this.options_.translator.translateDayOfWeek(dayOfWeek));
    };
    DateConverter_.prototype.parseDayOfWeekTextualFull_ = function (text) {
      const _this = this;
      return this.parseDayOfWeekByTranslator_(text, (dayOfWeek) => _this.options_.translator.translateDayOfWeekFull(dayOfWeek));
    };
    ...
    DateConverter_.prototype.parseMonthTextual_ = function (text, dateData) {
      const _this = this;
      return this.parseMonthByTranslator_(text, dateData, (month) => _this.options_.translator.translateMonth(month));
    };
    DateConverter_.prototype.parseMonthTextualShort_ = function (text, dateData) {
      const _this = this;
      return this.parseMonthByTranslator_(text, dateData, (month) => _this.options_.translator.translateMonthShort(month));
    };
...
(function (TheDatepicker) {
  ...
  const Datepicker = (function () {
    function Datepicker(input, container, options) {
      ...
      } else if (typeof container.datepicker !== 'undefined') {
      ...
      switch (this.initializationPhase_) {
        ...
        case InitializationPhase.Untouched:
          ...
          if (this.input !== null && this.options.isHiddenOnBlur()) {
            ...
            this.inputListenerRemover_ = TheDatepicker.Helper_.addEventListener_(this.input, TheDatepicker.ListenerType_.Focus, (event) => {
              _this.open(event);
            });
    ...
    Datepicker.prototype.initListeners_ = function () {
      ...
      if (!Datepicker.areGlobalListenersInitialized_) {
        const activeViewModel = null;
        const checkMiss = function (event) {
        ...
        TheDatepicker.Helper_.addEventListener_(this.document_, TheDatepicker.ListenerType_.KeyDown, (event) => {
      ...
      if (this.input !== null) {
        ...
        this.listenerRemovers_.push(TheDatepicker.Helper_.addEventListener_(this.input, TheDatepicker.ListenerType_.Blur, () => {
          _this.updateInput_();
        }));
        this.listenerRemovers_.push(TheDatepicker.Helper_.addEventListener_(this.input, TheDatepicker.ListenerType_.KeyDown, (event) => {
          TheDatepicker.Helper_.stopPropagation_(event);
        }));
        this.listenerRemovers_.push(TheDatepicker.Helper_.addEventListener_(this.input, TheDatepicker.ListenerType_.KeyUp, (event) => {
...
(function (TheDatepicker) {
  ...
  const AvailableDateNotFoundException = (function () {
  ...
  const Options = (function () {
    ...
    Options.prototype.setMinDate = function (date) {
      const normalizedDate = TheDatepicker.Helper_.normalizeDate_('Min date', date, this);
    ...
    Options.prototype.setMaxDate = function (date) {
      const normalizedDate = TheDatepicker.Helper_.normalizeDate_('Max date', date, this);
  ...
  const Template_ = (function () {
    ...
    Template_.prototype.createBodyElement_ = function (viewModel) {
      ...
      if (this.options_.isMonthChangeOnSwipeEnabled_()) {
        TheDatepicker.Helper_.addSwipeListener_(body, (event, isRightMove) => {
    ...
    Template_.prototype.createResetElement_ = function (viewModel) {
      ...
      const resetButton = this.htmlHelper_.createAnchor_((event) => {
        viewModel.reset_(event);
      });
      resetButton.innerHTML = this.options_.getResetHtml();
      const title = this.options_.translator.translateTitle(TheDatepicker.TitleName.Reset);
      if (title !== '') {
    ...
    Template_.prototype.createCloseElement_ = function (viewModel) {
      ...
      const closeButton = this.htmlHelper_.createAnchor_((event) => {
        viewModel.close_(event);
      });
      closeButton.innerHTML = this.options_.getCloseHtml();
      const title = this.options_.translator.translateTitle(TheDatepicker.TitleName.Close);
      if (title !== '') {
    ...
    Template_.prototype.createGoElement_ = function (viewModel, directionForward) {
      ...
      const goButton = this.htmlHelper_.createAnchor_((event) => {
      ...
      const title = this.options_.translator.translateTitle(directionForward ? TheDatepicker.TitleName.GoForward : TheDatepicker.TitleName.GoBack);
      if (title !== '') {
    ...
    Template_.prototype.createMonthElement_ = function (viewModel) {
      ...
      const selectElement = this.htmlHelper_.createSelectInput_(options, (event, monthNumber) => {
    ...
    Template_.prototype.createYearElement_ = function (viewModel) {
      const _this = this;
      const selectElement = this.htmlHelper_.createSelectInput_([], (event, year) => {
        const currentMonth = viewModel.getCurrentMonth_();
        let newMonth = new Date(currentMonth.getTime());
        newMonth.setFullYear(parseInt(year, 10));
        const minMonth = _this.options_.getMinMonth_();
        const maxMonth = _this.options_.getMaxMonth_();
    ...
    Template_.prototype.updateYearElement_ = function (viewModel) {
      ...
      const diff = this.calculateDropdownDiff_(options, range, (value) => parseInt(value, 10));
    ...
    Template_.prototype.createMonthAndYearElement_ = function (viewModel) {
      ...
      const selectElement = this.htmlHelper_.createSelectInput_([], (event, value) => {
        const currentMonth = viewModel.getCurrentMonth_();
        const newMonth = new Date(currentMonth.getTime());
        const data = _this.parseMonthAndYearOptionValue_(value);
    ...
    Template_.prototype.updateMonthAndYearElement_ = function (viewModel) {
      ...
      const diff = this.calculateDropdownDiff_(options, range, (value) => _this.calculateMonthAndYearIndex_(_this.parseMonthAndYearOptionValue_(value)));
      for (var index = 0; index < diff.remove.length; index++) {
    ...
    Template_.prototype.createTableCellButtonElement_ = function (viewModel) {
      const _this = this;
      var cellButton = this.htmlHelper_.createAnchor_((event) => {
    ...
    Template_.prototype.slideMonth_ = function (viewModel, event, directionForward) {
      ...
      const animationIn = directionForward
        ? 'fade-in-right'
        : 'fade-in-left';
      var listenerRemover = TheDatepicker.Helper_.addEventListener_(this.bodyElement_, TheDatepicker.ListenerType_.AnimationEnd, (event) => {
        change();
        listenerRemover();
        ...
        listenerRemover = TheDatepicker.Helper_.addEventListener_(_this.bodyElement_, TheDatepicker.ListenerType_.AnimationEnd, (event) => {
          listenerRemover();
          _this.bodyElement_.className = _this.options_.prefixClass_('body');
        });
      });
...
(function (TheDatepicker) {
  ...
  const ViewModel_ = (function () {
    ...
    ViewModel_.prototype.highlightFirstAvailableDay_ = function (event) {
      const date = new Date(this.getCurrentMonth_().getTime());
      const maxDate = this.options_.getMaxDate_();
    ...
    ViewModel_.prototype.getWeeks_ = function () {
      ...
      if (this.options_.hasFixedRowsCount()) {
        for (let date_4 = appendDaysCount + 1; days.length < 6 * 7; date_4++) {
    ...
    ViewModel_.prototype.triggerOnBeforeSelect_ = function (event, day, previousDay) {
      const _this = this;
      return this.options_.triggerEvent_(TheDatepicker.EventType_.BeforeSelect, (listener) => listener.call(_this.datepicker_, event, day, previousDay));
    };
    ViewModel_.prototype.triggerOnSelect_ = function (event, day, previousDay) {
      const _this = this;
      this.options_.triggerEvent_(TheDatepicker.EventType_.Select, (listener) => listener.call(_this.datepicker_, event, day, previousDay));
    };
    ViewModel_.prototype.triggerOnBeforeOpenAndClose_ = function (event, isOpening) {
      const _this = this;
      return this.options_.triggerEvent_(TheDatepicker.EventType_.BeforeOpenAndClose, (listener) => listener.call(_this.datepicker_, event, isOpening));
    };
    ViewModel_.prototype.triggerOnOpenAndClose_ = function (event, isOpening) {
      const _this = this;
      this.options_.triggerEvent_(TheDatepicker.EventType_.OpenAndClose, (listener) => listener.call(_this.datepicker_, event, isOpening));
    };
    ViewModel_.prototype.triggerOnBeforeMonthChange_ = function (event, month, previousMonth) {
      const _this = this;
      return this.options_.triggerEvent_(TheDatepicker.EventType_.BeforeMonthChange, (listener) => listener.call(_this.datepicker_, event, month, previousMonth));
    };
    ViewModel_.prototype.triggerOnMonthChange_ = function (event, month, previousMonth) {
      const _this = this;
      this.options_.triggerEvent_(TheDatepicker.EventType_.MonthChange, (listener) => listener.call(_this.datepicker_, event, month, previousMonth));
    };
    ViewModel_.prototype.triggerOnBeforeFocus_ = function (event, day, previousDay) {
      const _this = this;
      return this.options_.triggerEvent_(TheDatepicker.EventType_.BeforeFocus, (listener) => listener.call(_this.datepicker_, event, day, previousDay));
    };
    ViewModel_.prototype.triggerOnFocus_ = function (event, day, previousDay) {
      const _this = this;
      this.options_.triggerEvent_(TheDatepicker.EventType_.Focus, (listener) => listener.call(_this.datepicker_, event, day, previousDay));
    };
    ViewModel_.prototype.createDay_ = function (date) {
      ...
      const day = new TheDatepicker.Day(date);
